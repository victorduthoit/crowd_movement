...
public class Individual {
	 ...
	 * @param people
	 */
	public Individual(double x, double y,double vx, double vy, Room room, LinkedList<Individual> people) {
		super();
		this.c = CI;
		id = people.size();
		this.breadth = R;
	...
	// Methods :
		...
		public void draw(Graphics g,int xp, int yp) {
				...
				int x0 = (int) x;
				int y0 = (int) y;
			    g.fillOval(xp+x0-r, yp+y0-r, 2*r, 2*r);
		}
		public void print() {
		...
		public boolean notSuperImposed(LinkedList<Individual> people) {
			...
			while (ok && indIt.hasNext()) {
				...
				if (!(ind==this)) {
					double xIt = ind.getX();
					double yIt = ind.getY();
					double ds = (this.x-xIt)*(this.x-xIt) + (this.y-yIt)*(this.y-yIt);
					ok = (ds >= 4*R*R);
				}
			}
			return ok;
...
//			v.print();
	  	...
	  	public static void main(String[] args) {
			...
			Individual ind1 = new Individual(20.,10.,0,0,room, people);
			people.add(ind1);
			Individual ind2 = new Individual(30,60,0.,0.,room, people);
			people.add(ind2);
			Individual ind3 = new Individual(70,25,0.,0.,room, people);
			people.add(ind3);
			ind1.print();
			ind2.print();
			ind3.print();
